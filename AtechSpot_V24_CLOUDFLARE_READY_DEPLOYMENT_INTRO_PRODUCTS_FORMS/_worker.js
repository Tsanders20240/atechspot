...
export default{
  async fetch(request,env){
    ...
    if(url.pathname==="/api/form-health"){
      ...
      return json(configured?200:503,{ok:configured,resendConfigured:configured,recipient:env.FORM_TO_EMAIL||"aplustechucation@gmail.com",deployment:"V24-CLOUDFLARE-READY"});
    }
