(()=>{'use strict';
const WORDS=[
['A','Android','A mobile operating system used on many phones and tablets.','Android','Un sistema operativo móvil usado en muchos teléfonos y tabletas.','🤖','a-android.pdf'],
['B','Bitcoin','A type of digital money that exists electronically.','Bitcoin','Un tipo de dinero digital que existe electrónicamente.','₿','b-bitcoin.pdf'],
['C','Cache','Temporary stored data that can help a device or website load faster.','Caché','Datos temporales guardados que pueden ayudar a cargar más rápido.','🗂️','c-cache.pdf'],
...
['F','Floppy Disk','An older removable disk once used to save computer files.','Disquete','Un disco removible antiguo usado para guardar archivos.','💾','f-floppy-disk.pdf'],
['G','Gaming','Playing electronic or video games.','Videojuegos','Jugar juegos electrónicos o de video.','🎮','g-gaming.pdf'],
['H','Hardware','The physical parts of a computer or technology device.','Hardware','Las partes físicas de una computadora o dispositivo.','🖥️','h-hardware.pdf'],
...
['O','Operating System','Core software that helps a device run apps and manage hardware.','Sistema operativo','Software principal que ayuda a un dispositivo a ejecutar aplicaciones.','⚙️','o-operating-system.pdf'],
...
['T','Technology','Tools and systems people create to solve problems and do things.','Tecnología','Herramientas y sistemas creados para resolver problemas.','💡','t-technology.pdf'],
...
['X','XTC','An ABC of Technology learning term represented by the letters X-T-C.','XTC','Un término educativo de ABC of Technology representado por X-T-C.','✖️','x-xtc.pdf'],
